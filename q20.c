// 20. Write a program to implement a Hash Table using linear probing as the collision resolution 
// strategy. The table should support the following operations: 
// a. Insert 
// b. Search
